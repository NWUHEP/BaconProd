...
namespace baconhep
{
  class FillerJet_REDUCED
  {
    ...
    //std::string fSVTagInfoName;
      ...
      std::string fDeepDoubleBvLtagName;
      std::string fDeepDoubleBvLNoMassSculptPentagName;
      std::string fDeepDoubleCvLtagName;
      std::string fDeepDoubleCvLNoMassSculptPentagName;
      std::string fDeepDoubleCvBtagName;
      std::string fDeepDoubleCvBNoMassSculptPentagName;
    ...
    edm::EDGetTokenT<reco::JetTagCollection>   fTokDeepDoubleBvLtagName;
    edm::EDGetTokenT<reco::JetTagCollection>   fTokDeepDoubleBvLNoMassSculptPentagName;
    edm::EDGetTokenT<reco::JetTagCollection>   fTokDeepDoubleCvLtagName;
    edm::EDGetTokenT<reco::JetTagCollection>   fTokDeepDoubleCvLNoMassSculptPentagName;
    edm::EDGetTokenT<reco::JetTagCollection>   fTokDeepDoubleCvBtagName;
    edm::EDGetTokenT<reco::JetTagCollection>   fTokDeepDoubleCvBNoMassSculptPentagName;
